...
L.tileLayer('https://api.maptiler.com/maps/pastel/{z}/{x}/{y}.png?key=2hTOFLPdXApzq9gVeMKq', {
...
var geojson = {
    ...
    "features": [{
        ...
        "type": "Feature",
        "properties": {
            "Titolo": "Geo-tagged social media post patterns in the attendance of fair",
            "Tipo": "GIS",
        ...
        "properties": {
            ...
            "Tipo": "3D Inspections",
            "Info": "<a href='portfolio/index.html#dams'>More info about the project</a>",
        ...
        "type": "Feature",
        "properties": {
            "Titolo": "Natural disaster impact analysis parsing geo-tagged social media post",
            "Tipo": "GIS",
...
L.geoJSON(geojson, {
    ...
    onEachFeature: function (feature, layer) {
        layer.bindPopup("<b>" + feature.properties.Titolo + "</b>" + "</br>" + "<i>" + feature.properties.Tipo + "</i> - " + feature.properties.Place + "</br>" + feature.properties.Info);
    }
}).addTo(map);
